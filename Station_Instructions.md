...
2) Create Config sheet
   ...
   - Enter these cells:
       A1: StationID    | B1: Station01   (change per station to Station01..Station12)
...
Notes
- The macro writes to StationXX_log.csv in the configured ScanFolder. If network is down, it writes to a local PendingScans folder and attempts to flush pending files on open.
